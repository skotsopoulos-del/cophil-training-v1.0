...
::: {.resource-card}
<i class="bi bi-chat-dots-fill" style="font-size: 2.5rem; color: #003399; margin-bottom: 1rem;"></i>

### Questions & Support
Ask questions, report issues, or discuss course content with instructors and fellow participants.

[Ask a Question →](https://github.com/skotsopoulos-del/cophil-training-v1.0/issues){.btn .btn-outline-primary .btn-sm target="_blank"}
:::
:::
...
Visit our [GitHub Issues page](https://github.com/skotsopoulos-del/cophil-training-v1.0/issues){target="_blank"} to:
...
[Ask a Question or Report an Issue →](https://github.com/skotsopoulos-del/cophil-training-v1.0/issues){.btn .btn-primary target="_blank"}
:::
...
- **Questions & Issues:** Post on [GitHub Issues](https://github.com/skotsopoulos-del/cophil-training-v1.0/issues){target="_blank"} for community support
- **Google Colab problems:** See [Setup Guide](resources/setup.qmd)
- **Data access issues:** Check session-specific troubleshooting
- **Course questions:** Ask during live sessions or post on GitHub Issues
- **Email support:** [skotsopoulos@neuralio.ai](mailto:skotsopoulos@neuralio.ai)
:::
